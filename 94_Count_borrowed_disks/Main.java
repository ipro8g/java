...
class Disk extends Multimedia implements Loanable{
...
public class Main{
    ...
    public static void main(String[] args){
        ...
        Disk[] disks = {new Disk("On The Planet", "Meiko Nakahara", Format.mp3, (double)30, "City Pop"), new Disk("Go Ahead", "Tatsuro Yamashita", Format.mp3, (double)40, "Jfunk"), new Disk("After 5 Clash", "Toshiki Kadomatsu", Format.mp3, (double)35, "City Pop")};

        ((Loanable)disks[0]).to_borrow();
        ((Loanable)disks[2]).to_borrow();
        ...
        System.out.println(obj.count_borrowed(disks) + " borrowed disks");
    }
}
